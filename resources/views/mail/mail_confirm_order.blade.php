                  ...
                  <tr>
                    <th valign="top" style="mso-line-height-rule: exactly;">
                      ...
                      <table class="section_wrapper header" data-id="header" id="section-header" border="0" width="100%" cellpadding="0" cellspacing="0" align="center" style="min-width: 100%;" role="presentation" bgcolor="#f15d2a">
                        <tr>
                          <td class="section_wrapper_th" style="mso-line-height-rule: exactly; padding-top: 22px; padding-bottom: 22px;" bgcolor="#f5f3f3">
                            <table border="0" width="100%" cellpadding="0" cellspacing="0" align="center" style="min-width: 100%;" role="presentation">
                              <tr>
                                <th class="column_logo" style="mso-line-height-rule: exactly; padding-top: 0; padding-bottom: 0;" align="center" bgcolor="#f5f3f3">

                                  <!-- Logo : BEGIN -->
                                  <a href="{{url('')}}" target="_blank" style="color: #a7a7a7; text-decoration: none !important; text-underline: none;">
                                    <img src="{{asset('site_assets/images/logo.png')}}" class="logo " width="128" border="0" style="width: 128px; height: auto !important; display: block; text-align: center; margin: auto;">
                                  </a>
                              ...
                              <tr id="section-3499739" class="section order_number_and_date">
                                <th style="mso-line-height-rule: exactly; padding: 11px 44px;" bgcolor="#ffffff">
                                  <h2 style="font-family: -apple-system,BlinkMacSystemFont,'Segoe UI',Arial,'Roboto'; color: #1a1a1a; font-size: 16px; line-height: 22px; font-weight: 400; text-transform: none; margin: 0;" align="left">
                                    <span data-key="3499739_order_number">ORDER</span> #{{$Recipt->id}}
                                  </h2>
                                  <p class="muted" style="mso-line-height-rule: exactly; font-family: -apple-system,BlinkMacSystemFont,'Segoe UI',Arial,'Roboto'; font-size: 13px; line-height: 22px; font-weight: normal; text-transform: none; color: #ef5a30; margin: 0;" align="left">{{$Recipt->created_at}}</p>
                                </th>
                              </tr>
                              ...
                              <tr id="section-3499735" class="section introduction">
                                <th style="mso-line-height-rule: exactly; padding: 11px 44px;" bgcolor="#ffffff">
                                  <p style="mso-line-height-rule: exactly; font-family: -apple-system,BlinkMacSystemFont,'Segoe UI',Arial,'Roboto'; font-size: 15px; line-height: 22px; font-weight: 400; text-transform: none; color: #000000; margin: 0 0 11px;" align="left"> <span data-key="3499735_greeting_text" style="text-align: left; font-family: -apple-system,BlinkMacSystemFont,'Segoe UI',Arial,'Roboto'; font-size: 15px; line-height: 22px; font-weight: 400; text-transform: none; color: #000000;">
                                    ...
                                    {{$member->name}},</p> <span data-key="3499735_introduction_text"
                                  class="text" style="text-align: left; font-family: -apple-system,BlinkMacSystemFont,'Segoe UI',Arial,'Roboto'; font-size: 15px; line-height: 22px; font-weight: 400; text-transform: none; color: #000000;">
                                        ...
                                        <p style="mso-line-height-rule: exactly; font-family: -apple-system,BlinkMacSystemFont,'Segoe UI',Arial,'Roboto'; font-size: 15px; line-height: 22px; font-weight: 400; text-transform: none; color: #000000; margin: 11px 0 0;" align="left">Thank you for your purchase, this email confirms your order. We will contact you soon.</p>
                                      </span>
                                </th>
                              </tr>
                                        ...
                                        <table cellspacing="0" cellpadding="0" border="0" width="100%" style="min-width: 100%;" role="presentation">
                                          <tr>
                                            <th colspan="2" class="product-table-h3-wrapper" style="mso-line-height-rule: exactly;" bgcolor="#ffffff" valign="top">
                                              <h3 data-key="3499741_item" style="font-family: -apple-system,BlinkMacSystemFont,'Segoe UI',Arial,'Roboto'; color: #1a1a1a; font-size: 14px; line-height: 22px; font-weight: 400; text-transform: none; border-bottom-width: 1px; border-bottom-color: #eeeeee; border-bottom-style: solid; margin: 0;" align="left"> <b>ITEMS ORDERED</b> </h3>
                                            </th>
                                          </tr>
                                          ...
                                          <!-- end Bold 2 -->
                                          @foreach ($Recipt->Products as $key => $product)
                                            <tr class="row-border-bottom">
                                              <th class="table-stack product-image-wrapper stack-column-center" width="1" style="mso-line-height-rule: exactly; border-bottom-width: 1px; border-bottom-color: #eeeeee; border-bottom-style: solid; padding: 11px 11px 11px 0;" bgcolor="#ffffff" valign="middle">
                                                <a href="{{$product->product_link}}" class="product_link" target="_blank" style="color: #0c0c09; text-decoration: none !important; text-underline: none; word-wrap: break-word;">
                                                  <img width="120" class="product-image" src="{{$product->image}}" alt='Layover Stretch Travel Shorts 19" - Dark Khaki / 33' style="vertical-align: middle; text-align: center; width: 120px; max-width: 120px; height: auto !important; border-radius: 0px; padding: 0px;">
                                                </a>
                                              </th>
                                                  ...
                                                  <tr>
                                                    <th class="line-item-description" style="mso-line-height-rule: exactly; font-family: -apple-system,BlinkMacSystemFont,'Segoe UI',Arial,'Roboto'; font-size: 15px; line-height: 22px; font-weight: 400; text-transform: none; color: #000000; padding: 11px 5px 11px 0;" align="left" bgcolor="#ffffff" valign="top">
                                                      <p style="mso-line-height-rule: exactly; font-family: -apple-system,BlinkMacSystemFont,'Segoe UI',Arial,'Roboto'; font-size: 15px; line-height: 22px; font-weight: 400; text-transform: none; color: #000000; margin: 0;" align="left">
                                                        <a href="{{$product->product_link}}" class="product_link" target="_blank" style="color: #000000; text-decoration: none !important; text-underline: none; word-wrap: break-word; text-align: left !important; font-weight: 400;"> {{$product->product_name}} </a>
                                                        <br> <span class="muted" style="text-align: left; font-family: -apple-system,BlinkMacSystemFont,'Segoe UI',Arial,'Roboto'; font-size: 13px; line-height: 22px; font-weight: normal; text-transform: none; color: #ef5a30;"> {{$product->member_brief}}</span>
                                                        {{-- <br> <span style="font-size: 16px; color: #F26A46; font-weight: 600;" class="order-list__item-shippingdate">{{$product->single_price}}EGP</span> --}}
                                                        <br>
                                                      </p>
                                                    </th>
                                                    ...
                                                    <th class="right line-item-qty" width="1" style="mso-line-height-rule: exactly; white-space: nowrap; padding: 11px 0 11px 11px;" align="right" bgcolor="#ffffff" valign="top">
                                                      <p style="mso-line-height-rule: exactly; font-family: -apple-system,BlinkMacSystemFont,'Segoe UI',Arial,'Roboto'; font-size: 15px; line-height: 22px; font-weight: 400; text-transform: none; color: #000000; margin: 0;" align="right">{{$product->package_type}}</p>
                                                    </th>
                                                    <th class="right line-item-line-price" width="1" style="mso-line-height-rule: exactly; white-space: nowrap; padding: 11px 0 11px 22px;" align="right" bgcolor="#ffffff" valign="top">
                                                      <p style="mso-line-height-rule: exactly; font-family: -apple-system,BlinkMacSystemFont,'Segoe UI',Arial,'Roboto'; font-size: 15px; line-height: 22px; font-weight: 400; text-transform: none; color: #000000; margin: 0;" align="right">{{$product->price}} EGP</p>
                                                    </th>
                                                  </tr>
                                                </table>
                                              </th>
                                      ...
                                      <th class="pricing-table" style="mso-line-height-rule: exactly; padding: 11px 0;" bgcolor="#ffffff" valign="top">
                                        <table cellspacing="0" cellpadding="0" border="0" width="100%" style="min-width: 100%;" role="presentation">
                                          <tr>
                                            ...
                                            <th class="table-text" style="mso-line-height-rule: exactly; font-family: -apple-system,BlinkMacSystemFont,'Segoe UI',Arial,'Roboto'; font-size: 15px; line-height: 22px; font-weight: 400; text-transform: none; color: #000000; width: 35%; padding: 5px 0;" align="right" bgcolor="#ffffff" valign="middle"> {{$Recipt->total_price}} EGP </th>
                                          </tr>

                                          @if ($Recipt->discount_percentage)
                                            <tr>
                                              <th class="table-title" style="mso-line-height-rule: exactly; font-family: -apple-system,BlinkMacSystemFont,'Segoe UI',Arial,'Roboto'; font-size: 15px; line-height: 22px; font-weight: 400; text-transform: none; color: #000000; width: 65%; padding: 5px 0;" align="left" bgcolor="#ffffff" valign="top">Discount Percentage </th>
                                              <th class="table-text" style="mso-line-height-rule: exactly; font-family: -apple-system,BlinkMacSystemFont,'Segoe UI',Arial,'Roboto'; font-size: 15px; line-height: 22px; font-weight: 400; text-transform: none; color: #000000; width: 35%; padding: 5px 0;" align="right" bgcolor="#ffffff" valign="middle">{{$Recipt->discount_percentage}}%</th>
                                            </tr>
                                          @endif
                                          @if ($Recipt->vat_price)
                                          <tr>
                                            <th class="table-title" style="mso-line-height-rule: exactly; font-family: -apple-system,BlinkMacSystemFont,'Segoe UI',Arial,'Roboto'; font-size: 15px; line-height: 22px; font-weight: 400; text-transform: none; color: #000000; width: 65%; padding: 5px 0;" align="left" bgcolor="#ffffff" valign="top">Vat price</th>
                                            <th class="table-text" style="mso-line-height-rule: exactly; font-family: -apple-system,BlinkMacSystemFont,'Segoe UI',Arial,'Roboto'; font-size: 15px; line-height: 22px; font-weight: 400; text-transform: none; color: #000000; width: 35%; padding: 5px 0;" align="right" bgcolor="#ffffff" valign="middle">{{$Recipt->vat_price}} EGP</th>
                                          </tr>
                                          @endif
                                          @if ($Recipt->wallet_deduction)
                                            <tr>
                                              <th class="table-title" style="mso-line-height-rule: exactly; font-family: -apple-system,BlinkMacSystemFont,'Segoe UI',Arial,'Roboto'; font-size: 15px; line-height: 22px; font-weight: 400; text-transform: none; color: #000000; width: 65%; padding: 5px 0;" align="left" bgcolor="#ffffff" valign="top">Wallet deduction </th>
                                              <th class="table-text" style="mso-line-height-rule: exactly; font-family: -apple-system,BlinkMacSystemFont,'Segoe UI',Arial,'Roboto'; font-size: 15px; line-height: 22px; font-weight: 400; text-transform: none; color: #000000; width: 35%; padding: 5px 0;" align="right" bgcolor="#ffffff" valign="middle">{{$Recipt->wallet_deduction}} EGP</th>
                                            </tr>
                                          @endif
                                          <tr class="pricing-table-total-row">
                                            ...
                                            <th class="table-text" style="mso-line-height-rule: exactly; font-family: -apple-system,BlinkMacSystemFont,'Segoe UI',Arial,'Roboto'; font-size: 15px; line-height: 22px; font-weight: 400; text-transform: none; color: #1a1a1a; width: 35%; padding: 5px 0;" align="right" bgcolor="#ffffff" valign="middle">{{$Recipt->final_price}} EGP</th>
                                          </tr>
                                        </table>
                                      </th>
                                    </tr>
                                  ...
                                  <table class="table-inner" cellspacing="0" cellpadding="0" border="0" width="100%" style="min-width: 100%;" role="presentation">
                                    ...
                                    <tr>
                                      <th colspan="2" style="mso-line-height-rule: exactly;" bgcolor="#ffffff" valign="top">
                                        <h3 data-key="3499742_payment_info" style="font-family: -apple-system,BlinkMacSystemFont,'Segoe UI',Arial,'Roboto'; color: #1a1a1a; font-size: 14px; line-height: 22px; font-weight: 400; text-transform: none; border-bottom-width: 1px; border-bottom-color: #eeeeee; border-bottom-style: solid; margin: 0;" align="left"> <b> Payment Info</b> </h3>
                                      </th>
                                    </tr>
                                        ...
                                        <table cellspacing="0" cellpadding="0" border="0" width="100%" style="min-width: 100%;" role="presentation">
                                          <tr>
                                            ...
                                            <th style="mso-line-height-rule: exactly; font-family: -apple-system,BlinkMacSystemFont,'Segoe UI',Arial,'Roboto'; font-size: 15px; line-height: 22px; font-weight: 400; text-transform: none; color: #000000; padding: 7px 0;" align="left" bgcolor="#ffffff" valign="middle">
                                               @if ($Recipt->payment_method == 'cod')
                                                  Cash on delivery
                                               @elseif ($Recipt->payment_method == 'creadit_card')
                                                  Creadit Card
                                               @elseif ($Recipt->payment_method == 'vod')
                                                  Creadit Card on delivery
                                               @endif
                                            </th>
                                          </tr>
                                        </table>
                                        ...
                                        <table align="center" border="0" width="100%" cellpadding="0" cellspacing="0" style="min-width: 100%;" role="presentation">
                                          <tr>
                                            <th style="mso-line-height-rule: exactly; padding-right: 5%;" align="left" bgcolor="#ffffff" valign="top">
                                              <h3 data-key="3499740_ship_to" style="font-family: -apple-system,BlinkMacSystemFont,'Segoe UI',Arial,'Roboto'; color: #1a1a1a; font-size: 14px; line-height: 22px; font-weight: 400; text-transform: none; margin: 0;" align="left"> <b> Shipping Address</b></h3>
                                            </th>
                                          </tr>
                                          <tr>
                                        ...
                                        <table align="center" border="0" width="100%" cellpadding="0" cellspacing="0" style="min-width: 100%;" role="presentation">
                                          <tr>
                                            <th style="mso-line-height-rule: exactly; padding-left: 5%;" align="right" bgcolor="#ffffff" valign="top">
                                              <h3 data-key="3499740_bill_to" style="font-family: -apple-system,BlinkMacSystemFont,'Segoe UI',Arial,'Roboto'; color: #1a1a1a; font-size: 14px; line-height: 22px; font-weight: 400; text-transform: none; margin: 0;" align="right"> <b>Info</b> </h3>
                                            </th>
                                          </tr>
                                          <tr>
                                            <th class="billing_address " style="mso-line-height-rule: exactly; padding-left: 5%;" align="right" bgcolor="#ffffff" valign="top">
                                              <p style="mso-line-height-rule: exactly; font-family: -apple-system,BlinkMacSystemFont,'Segoe UI',Arial,'Roboto'; font-size: 15px; line-height: 22px; font-weight: 400; text-transform: none; color: #000000; margin: 0;" align="right">
                                                Building: {{$Recipt->building_no}}
                                                <br>Apartment: {{$Recipt->apartment_no}}
                                                <br>Phone: {{$member->phone}}
                                                <br> {{$member->email}}
...
<!--[if mso]>&nbsp;&nbsp;&nbsp;&nbsp;<![endif]--><span data-key="3499736_text_on_button" style="line-height: 15px; color: #ffffff; font-weight: 400; text-decoration: none; text-underline: none; letter-spacing: 0.5px;">VIEW ORDER STATUS</span>
                                    ...
                                    <tr>
                                      <th class="sides column_text_after_button muted" data-key="3499736_text_after_button" style="mso-line-height-rule: exactly; font-family: -apple-system,BlinkMacSystemFont,'Segoe UI',Arial,'Roboto'; font-size: 13px; line-height: 22px; font-weight: normal; text-transform: none; color: #ef5a30; padding: 0 44px;" align="center" bgcolor="#ffffff" valign="top">
                                        <p style="mso-line-height-rule: exactly; font-family: -apple-system,BlinkMacSystemFont,'Segoe UI',Arial,'Roboto'; font-size: 13px; line-height: 22px; font-weight: normal; text-transform: none; color: #ef5a30; margin: 0;text-align: center;" align="center"  ><i style="text-align: center;" >If you would like to change your order, Please call {{$site_settings['our_phone_1']}} or email us on {{$site_settings['our_email']}}</i>
                                        </p>
                                        {{-- <p style="mso-line-height-rule: exactly; font-family: -apple-system,BlinkMacSystemFont,'Segoe UI',Arial,'Roboto'; font-size: 13px; line-height: 22px; font-weight: normal; text-transform: none; color: #ef5a30; margin: 11px 0 0;text-align: center;" align="center">
                                            <i style="text-align: center;"> Hope you found what you were looking for and enjoyed a smooth shopping experience! Looking forward to deliver to you again soon! </i>
                                        </p> --}}
                                      </th>
                                    </tr>
                                  </table>
                                  ...
                                  <table border="0" width="100%" cellpadding="0" cellspacing="0" role="presentation">
                                    ...
                                    <tr>
                                      <th class="column_shop_block2 " data-key="section_shop_block2" width="100%" style="mso-line-height-rule: exactly; font-family: -apple-system,BlinkMacSystemFont,'Segoe UI',Arial,'Roboto'; font-size: 14px; line-height: 22px; font-weight: 400; color: #000000; text-transform: none;" align="center" bgcolor="#ffffff">
                                        <p style="mso-line-height-rule: exactly; font-family: -apple-system,BlinkMacSystemFont,'Segoe UI',Arial,'Roboto'; font-size: 14px; line-height: 22px; font-weight: 400; text-transform: none; color: #000000; margin: 0;" align="center">Copyright © 2020 deledeal, All rights reserved.</p>
                                       </th>
                                    </tr>
                                    ...
                                    <tr>
                                      <th class="column_footer_logo footer_logo_wrapper" width="50%" style="mso-line-height-rule: exactly; padding: 22px 0;" align="center" bgcolor="#ffffff">
                                        ...
                                        <!-- Footer Logo : BEGIN -->
                                        <a href="{{url('')}}" target="_blank" style="color: #000000; text-decoration: none !important; text-underline: none; font-size: 14px;">
                                          <img src="{{asset('site_assets/images/logo.png')}}" class="footer_logo " alt="Roark" width="70" border="0" style="width: 70px; height: auto !important; display: block; text-align: center; margin: auto;">
