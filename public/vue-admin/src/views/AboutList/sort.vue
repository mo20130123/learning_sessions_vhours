<template>
  <div class="page-wrapper">
     ...
     <h2 class="font-italic font-weight-light font-weight-bold">About List sort</h2>

      <div>
         <router-link to="/AboutList"> <span> About List </span> </router-link> / <span>Sort</span>
      </div>
...
<script>
  ...
  export default {
    ...
    data: () => ({
        ...
        api_get_listWithoutPaginate: 'AboutList/list_without_paginate',
        api_updateRowsPosition: 'AboutList/updateRowsPosition',
    }),//end data
    created(){
