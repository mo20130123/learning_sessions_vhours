<template>
  <div class="page-wrapper">
     ...
     <h2 class="font-italic font-weight-light font-weight-bold">About List</h2>
     ...
     <section class="section-page-control">
        <v-row>
           <v-col cols="7" >
             ...
             <router-link to="/AboutList/sort"> <v-btn class="ma-2" outlined color="black"> <b-icon-filter></b-icon-filter> Sort  </v-btn> </router-link>
                      ...
                      <v-row>
                        <v-col>
                            <div class="div_Preview_image">
                               ...
                               <v-file-input @change="Preview_image($event,'Preview_image_create')" label="Image" name="image" hint="1030*898 Pixels" persistent-hint="true" prepend-icon="" show-size outlined ></v-file-input>
                            </div>
                            <div class="div_Preview_image">
                               <img id="Preview_icon_create" class="Preview_image" style="background-color:gray" >
                               <v-file-input @change="Preview_image($event,'Preview_icon_create')" label="Icon" name="icon" prepend-icon="" show-size outlined ></v-file-input>
                            </div>
                         </v-col>
                        <v-col>
                            ...
                            <v-textarea label="Description En" v-model="CF.description_en" name="input-7-4" outlined rows="6" :rules="requiredRules"></v-textarea>
                            <v-textarea label="Description Ar" v-model="CF.description_ar" name="input-7-4" outlined rows="6" :rules="requiredRules"></v-textarea>
                         </v-col>
                      </v-row>
                  </v-form>
                    <!-- - - - - - -START spinner- - - - - - - -->
                      ...
                      <v-row>
                        <v-col>
                            <div class="div_Preview_image">
                               ...
                               <v-file-input @change="Preview_image($event,'Preview_image_edit')" label="Image" name="image" hint="1030*898 Pixels" persistent-hint="true" prepend-icon="" show-size outlined ></v-file-input>
                            </div>
                            <div class="div_Preview_image">
                               <img :src="EF.icon" id="Preview_icon_edit" class="Preview_image" style="background-color:gray">
                               <v-file-input @change="Preview_image($event,'Preview_icon_edit')" label="Icon" name="icon" prepend-icon="" show-size outlined ></v-file-input>
                            </div>
                         </v-col>
                        <v-col>
                           ...
                           <v-textarea label="Description En" v-model="EF.description_en" name="input-7-4" outlined rows="6" :rules="requiredRules"></v-textarea>
                           <v-textarea label="Description Ar" v-model="EF.description_ar" name="input-7-4" outlined rows="6" :rules="requiredRules"></v-textarea>
                         </v-col>
                      </v-row>
                  </v-form>
                    <!-- - - - - - -START spinner- - - - - - - -->
...
<script>
  ...
  export default {
    ...
    mixins: [AdminMixin],
     data: () => ({
        Permission: 'AboutList',
        api_get_list: 'AboutList/list',
        api_showORhide: 'AboutList/showORhide',
        api_delete: 'AboutList/delete',
        api_create: 'AboutList/create',
        api_update: 'AboutList/update',
    }),//end data
    created(){
