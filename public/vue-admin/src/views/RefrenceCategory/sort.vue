<template>
  <div class="page-wrapper">
     ...
     <h2 class="font-italic font-weight-light font-weight-bold">Refrence Categories sort</h2>

      <div>
         <router-link to="/RefrenceCategory"> <span> Refrence Categories </span> </router-link> / <span>Sort</span>
      </div>
...
<script>
  ...
  export default {
    name: 'RefrenceCategory-sort',
    mixins: [AdminSortMixin],
    data: () => ({
        Permission: 'Refrence',
        api_get_listWithoutPaginate: 'RefrenceCategory/list_without_paginate',
        api_updateRowsPosition: 'RefrenceCategory/updateRowsPosition',
    }),//end data
    created(){
