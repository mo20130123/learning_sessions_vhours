<template>
  <div class="page-wrapper">
     ...
     <h2 class="font-italic font-weight-light font-weight-bold">Refrence Categories</h2>
     ...
     <section class="section-page-control">
        <v-row>
           <v-col cols="7" >
             ...
             <router-link to="/RefrenceCategory/sort"> <v-btn class="ma-2" outlined color="black"> <b-icon-filter></b-icon-filter> Sort  </v-btn> </router-link>
...
<script>
  ...
  export default {
    ...
    mixins: [AdminMixin],
     data: () => ({
        Permission: 'Refrence',
        api_get_list: 'RefrenceCategory/list',
        api_showORhide: 'RefrenceCategory/showORhide',
        api_delete: 'RefrenceCategory/delete',
        api_create: 'RefrenceCategory/create',
        api_update: 'RefrenceCategory/update',
    }),//end data
    created(){
