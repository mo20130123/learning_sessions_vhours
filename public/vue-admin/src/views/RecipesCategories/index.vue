...
<template>
  <div class="page-wrapper">
     ...
     <h2 class="font-italic font-weight-light font-weight-bold">Recipes Categories</h2>
     ...
     <section class="section-page-control">
        <v-row>
           <v-col cols="7" >
             ...
             <router-link to="/RecipesCategories/sort"> <v-btn class="ma-2" outlined color="black"> <b-icon-filter></b-icon-filter> Sort  </v-btn> </router-link>
...
<script>
  ...
  export default {
    ...
    mixins: [AdminMixin],
     data: () => ({
        Permission: 'Recipe',
        api_get_list: 'RecipesCategories/list',
        api_showORhide: 'RecipesCategories/showORhide',
        api_delete: 'RecipesCategories/delete',
        api_create: 'RecipesCategories/create',
        api_update: 'RecipesCategories/update',
    }),//end data
    created(){
