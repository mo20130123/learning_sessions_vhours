<template>
  <div class="page-wrapper">
     ...
     <h2 class="font-italic font-weight-light font-weight-bold">Recipes Categories sort</h2>

      <div>
         <router-link to="/RecipesCategories"> <span> Recipes Categories </span> </router-link> / <span>Sort</span>
      </div>
...
<script>
  ...
  export default {
    name: 'RecipesCategories-sort',
    mixins: [AdminSortMixin],
    data: () => ({
        Permission: 'Recipe',
        api_get_listWithoutPaginate: 'RecipesCategories/list_without_paginate',
        api_updateRowsPosition: 'RecipesCategories/updateRowsPosition',
    }),//end data
    created(){
