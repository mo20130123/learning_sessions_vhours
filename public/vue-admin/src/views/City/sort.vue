<template>
  <div class="page-wrapper">
     ...
     <h2 class="font-italic font-weight-light font-weight-bold">City sort</h2>

      <div>
         <router-link to="/City"> <span> City </span> </router-link> / <span>Sort</span>
      </div>
...
<script>
  ...
  export default {
    ...
    data: () => ({
        Permission: 'City',
        api_get_listWithoutPaginate: 'City/list_without_paginate',
        api_updateRowsPosition: 'City/updateRowsPosition',
    }),//end data
    created(){
    },
    methods:{
