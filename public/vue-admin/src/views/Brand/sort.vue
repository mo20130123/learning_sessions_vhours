<template>
  <div class="page-wrapper">
     ...
     <h2 class="font-italic font-weight-light font-weight-bold">Brand sort</h2>

      <div>
         <router-link to="/Brand"> <span> Brand </span> </router-link> / <span>Sort</span>
      </div>
...
<script>
  ...
  export default {
    ...
    data: () => ({
        Permission: 'Brand',
        api_get_listWithoutPaginate: 'Brand/list_without_paginate',
        api_updateRowsPosition: 'Brand/updateRowsPosition',
    }),//end data
    created(){
