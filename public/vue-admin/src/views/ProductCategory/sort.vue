<template>
  <div class="page-wrapper">
     ...
     <h2 class="font-italic font-weight-light font-weight-bold">Product Categories sort</h2>

      <div>
         <router-link to="/ProductCategory"> <span> Product Categories </span> </router-link> / <span>Sort</span>
      </div>
...
<script>
  ...
  export default {
    name: 'ProductCategory-sort',
    mixins: [AdminSortMixin],
    data: () => ({
        Permission: 'Product',
        api_get_listWithoutPaginate: 'ProductCategory/list_without_paginate',
        api_updateRowsPosition: 'ProductCategory/updateRowsPosition',
    }),//end data
    created(){
