<template>
  <div class="page-wrapper">
     ...
     <h2 class="font-italic font-weight-light font-weight-bold">Product Categories</h2>
     ...
     <section class="section-page-control">
        <v-row>
           <v-col cols="7" >
             ...
             <router-link to="/ProductCategory/sort"> <v-btn class="ma-2" outlined color="black"> <b-icon-filter></b-icon-filter> Sort  </v-btn> </router-link>
...
<script>
  ...
  export default {
    ...
    mixins: [AdminMixin],
     data: () => ({
        Permission: 'Product',
        api_get_list: 'ProductCategory/list',
        api_showORhide: 'ProductCategory/showORhide',
        api_delete: 'ProductCategory/delete',
        api_create: 'ProductCategory/create',
        api_update: 'ProductCategory/update',
    }),//end data
    created(){
