<template>
  <div class="page-wrapper">
     ...
     <h2 class="font-italic font-weight-light font-weight-bold">Recipes sort</h2>

      <div>
         <router-link to="/Recipe"> <span> Recipes </span> </router-link> / <span>Sort</span>
      </div>
...
<script>
  ...
  export default {
    ...
    data: () => ({
        Permission: 'Recipe',
        api_get_listWithoutPaginate: 'Recipe/list_without_paginate',
        api_updateRowsPosition: 'Recipe/updateRowsPosition',
        Permission: 'Recipe'
    }),//end data
    created(){
