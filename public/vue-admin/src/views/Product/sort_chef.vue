<template>
  <div class="page-wrapper">
     ...
     <h2 class="font-italic font-weight-light font-weight-bold">Products Chef sort</h2>
...
<script>
  ...
  export default {
    name: 'Product-sort-chef',
    mixins: [AdminSortMixin],
    data: () => ({
        Permission: 'Product',
        api_get_listWithoutPaginate: 'Product/list_without_paginate/chef',
        api_updateRowsPosition: 'Product/updateRowsPositionWithclassification/chef',
        Permission: 'Product'
    }),//end data
    created(){
