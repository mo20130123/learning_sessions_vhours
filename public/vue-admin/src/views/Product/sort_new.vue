<template>
  <div class="page-wrapper">
     ...
     <h2 class="font-italic font-weight-light font-weight-bold">Products New sort</h2>
...
<script>
  ...
  export default {
    ...
    data: () => ({
        Permission: 'Product',
        api_get_listWithoutPaginate: 'Product/list_without_paginate/new',
        api_updateRowsPosition: 'Product/updateRowsPositionWithclassification/new',
        Permission: 'Product'
    }),//end data
    created(){
