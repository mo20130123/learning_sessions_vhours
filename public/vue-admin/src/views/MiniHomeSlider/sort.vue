<template>
  <div class="page-wrapper">
     ...
     <h2 class="font-italic font-weight-light font-weight-bold">Mini Home Slider sort</h2>

      <div>
         <router-link to="/miniHomeSlider"> <span> Mini Home Slider </span> </router-link> / <span>Sort</span>
      </div>
...
<script>
  ...
  export default {
    name: 'MiniHomeSlider-sort',
    mixins: [AdminSortMixin],
    data: () => ({
        Permission: 'MiniHomeSlider',
        api_get_listWithoutPaginate: 'MiniHomeSlider/list_without_paginate',
        api_updateRowsPosition: 'MiniHomeSlider/updateRowsPosition',
    }),//end data
    created(){
