<template>
  <div class="page-wrapper">
     ...
     <h2 class="font-italic font-weight-light font-weight-bold">Mini Home Slider</h2>
     ...
     <section class="section-page-control">
        <v-row>
           <v-col cols="7" >
             ...
             <router-link to="/MiniHomeSlider/sort"> <v-btn class="ma-2" outlined color="black"> <b-icon-filter></b-icon-filter> Sort  </v-btn> </router-link>
                      ...
                      <v-row>
                        <v-col>
                            <div class="div_Preview_image">
                               ...
                               <v-file-input @change="Preview_image($event,'Preview_image_create')" label="File input" name="image" prepend-icon="" show-size outlined ></v-file-input>
                            </div>
                      ...
                      <v-row>
                        <v-col>
                            <div class="div_Preview_image">
                               ...
                               <v-file-input @change="Preview_image($event,'Preview_image_edit')" label="File input" name="image" prepend-icon="" show-size outlined ></v-file-input>
                            </div>
...
<script>
  ...
  export default {
    ...
    mixins: [AdminMixin],
     data: () => ({
        Permission: 'MiniHomeSlider',
        api_get_list: 'MiniHomeSlider/list',
        api_showORhide: 'MiniHomeSlider/showORhide',
        api_delete: 'MiniHomeSlider/delete',
        api_create: 'MiniHomeSlider/create',
        api_update: 'MiniHomeSlider/update',
    }),//end data
    created(){
