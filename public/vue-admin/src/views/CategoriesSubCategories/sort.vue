<template>
  <div class="page-wrapper">
     ...
     <h2 class="font-italic font-weight-light font-weight-bold">Categories sort</h2>
...
<script>
  ...
  export default {
    ...
    data: () => ({
        ...
        api_get_listWithoutPaginate: 'CategoriesSubCategories/list_without_paginate',
        api_updateRowsPosition: 'CategoriesSubCategories/updateRowsPosition',
        Permission: 'CategoriesSubCategories'
    }),//end data
    created(){
