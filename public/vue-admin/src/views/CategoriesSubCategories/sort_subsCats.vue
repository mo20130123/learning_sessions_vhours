<template>
  <div class="page-wrapper">
     ...
     <h2 class="font-italic font-weight-light font-weight-bold">Sub Categories sort</h2>

      <div>
         <router-link to="/CategoriesSubCategories"> <span> Categories </span> </router-link> / <span>Sort</span>
      </div>
...
<script>
  ...
  export default {
    name: 'CategoriesSubCategories-sort',
    mixins: [AdminSortMixin],
    data: () => ({
        Permission: 'CategoriesSubCategories',
        api_get_listWithoutPaginate: 'CategoriesSubCategories/list_subsCats_without_paginate',
        api_updateRowsPosition: 'CategoriesSubCategories/updateSubsCatsRowsPosition',
        Permission: 'CategoriesSubCategories'
    }),//end data
    created(){
