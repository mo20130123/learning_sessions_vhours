<template>
  <div class="page-wrapper">
     ...
     <h2 class="font-italic font-weight-light font-weight-bold">TrustedBys sort</h2>

      <div>
         <router-link to="/TrustedBy"> <span> TrustedBy </span> </router-link> / <span>Sort</span>
      </div>
...
<script>
  ...
  export default {
    ...
    data: () => ({
        ...
        api_get_listWithoutPaginate: 'TrustedBy/list_without_paginate',
        api_updateRowsPosition: 'TrustedBy/updateRowsPosition',
    }),//end data
    created(){
