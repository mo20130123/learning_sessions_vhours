<template>
  <div class="page-wrapper">
     ...
     <h2 class="font-italic font-weight-light font-weight-bold">Popular Questions sort</h2>

      <div>
         <router-link to="/PromoCodes"> <span> PromoCodes </span> </router-link> / <span>Sort</span>
      </div>
...
<script>
  ...
  export default {
    name: 'PromoCodes-sort',
    mixins: [AdminSortMixin],
    data: () => ({
        Permission: 'PromoCodes',
        api_get_listWithoutPaginate: 'PromoCodes/list_without_paginate',
        api_updateRowsPosition: 'PromoCodes/updateRowsPosition',
    }),//end data
    created(){
