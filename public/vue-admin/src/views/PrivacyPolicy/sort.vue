<template>
  <div class="page-wrapper">
     ...
     <h2 class="font-italic font-weight-light font-weight-bold">Privacy Policy sort</h2>

      <div>
         <router-link to="/PrivacyPolicy"> <span> Product Categories </span> </router-link> / <span>Sort</span>
      </div>
...
<script>
  ...
  export default {
    ...
    data: () => ({
        ...
        api_get_listWithoutPaginate: 'PrivacyPolicy/list_without_paginate',
        api_updateRowsPosition: 'PrivacyPolicy/updateRowsPosition',
    }),//end data
    created(){
