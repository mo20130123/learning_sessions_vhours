<template>
  <div class="page-wrapper">
     ...
     <h2 class="font-italic font-weight-light font-weight-bold">Privacy Policy</h2>
     ...
     <section class="section-page-control">
        <v-row>
           <v-col cols="7" >
             ...
             <router-link to="/PrivacyPolicy/sort"> <v-btn class="ma-2" outlined color="black"> <b-icon-filter></b-icon-filter> Sort  </v-btn> </router-link>
          </v-col>
          <v-col>
                <div class="">
...
<script>
  ...
  export default {
    ...
    mixins: [AdminMixin],
     data: () => ({
        Permission: 'PrivacyPolicy',
        api_get_list: 'PrivacyPolicy/list',
        api_showORhide: 'PrivacyPolicy/showORhide',
        api_delete: 'PrivacyPolicy/delete',
        api_create: 'PrivacyPolicy/create',
        api_update: 'PrivacyPolicy/update',
    }),//end data
    created(){
