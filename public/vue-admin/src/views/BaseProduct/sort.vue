<template>
  <div class="page-wrapper">
     ...
     <h2 class="font-italic font-weight-light font-weight-bold">Base Products sort</h2>

      <div>
         <router-link to="/BaseProduct"> <span> Base Products </span> </router-link> / <span>Sort</span>
      </div>
...
<script>
  ...
  export default {
    name: 'BaseProduct-sort',
    mixins: [AdminSortMixin],
    data: () => ({
        Permission: 'BaseProduct',
        api_get_listWithoutPaginate: 'BaseProduct/list_without_paginate',
        api_updateRowsPosition: 'BaseProduct/updateRowsPosition',
    }),//end data
    created(){
