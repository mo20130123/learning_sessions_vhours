<template>
  <div class="page-wrapper">
     ...
     <h2 class="font-italic font-weight-light font-weight-bold">Refrences sort</h2>

      <div>
         <router-link to="/Refrence"> <span> Refrences </span> </router-link> / <span>Sort</span>
      </div>
...
<script>
  ...
  export default {
    ...
    data: () => ({
        Permission: 'Refrence',
        api_get_listWithoutPaginate: 'Refrence/list_without_paginate',
        api_updateRowsPosition: 'Refrence/updateRowsPosition',
    }),//end data
    created(){
