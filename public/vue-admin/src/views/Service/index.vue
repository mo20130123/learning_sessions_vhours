<template>
  <div class="page-wrapper">
     ...
     <h2 class="font-italic font-weight-light font-weight-bold">Service</h2>
     ...
     <section class="section-page-control">
        <v-row>
           <v-col cols="7" >
             ...
             <router-link to="/Service/sort"> <v-btn class="ma-2" outlined color="black"> <b-icon-filter></b-icon-filter> Sort  </v-btn> </router-link>
                      ...
                      <v-row>
                        <v-col>
                            <div class="div_Preview_image">
                               ...
                               <v-file-input @change="Preview_image($event,'Preview_image_create')" label="File input" name="image" hint="1920*770 Pixels" persistent-hint="true" prepend-icon="" show-size outlined ></v-file-input>
                            </div>
                      ...
                      <v-row>
                        <v-col>
                            <div class="div_Preview_image">
                               ...
                               <v-file-input @change="Preview_image($event,'Preview_image_edit')" label="File input" name="image" hint="1920*770 Pixels" persistent-hint="true" prepend-icon="" show-size outlined ></v-file-input>
                            </div>
...
<script>
  ...
  export default {
    ...
    mixins: [AdminMixin],
     data: () => ({
        Permission: 'Service',
        api_get_list: 'Service/list',
        api_showORhide: 'Service/showORhide',
        api_delete: 'Service/delete',
        api_create: 'Service/create',
        api_update: 'Service/update',
    }),//end data
    created(){
