<template>
  <div class="page-wrapper">
     ...
     <h2 class="font-italic font-weight-light font-weight-bold">Services sort</h2>

      <div>
         <router-link to="/Service"> <span> Service </span> </router-link> / <span>Sort</span>
      </div>
...
<script>
  ...
  export default {
    ...
    data: () => ({
        Permission: 'Service',
        api_get_listWithoutPaginate: 'Service/list_without_paginate',
        api_updateRowsPosition: 'Service/updateRowsPosition',
    }),//end data
    created(){
