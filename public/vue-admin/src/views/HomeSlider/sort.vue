<template>
  <div class="page-wrapper">
     ...
     <h2 class="font-italic font-weight-light font-weight-bold">Home Slider sort</h2>

      <div>
         <router-link to="/HomeSlider"> <span> Home Slider </span> </router-link> / <span>Sort</span>
      </div>
...
<script>
  ...
  export default {
    name: 'HomeSlider-sort',
    mixins: [AdminSortMixin],
    data: () => ({
        Permission: 'HomeSlider',
        api_get_listWithoutPaginate: 'HomeSlider/list_without_paginate',
        api_updateRowsPosition: 'HomeSlider/updateRowsPosition',
    }),//end data
    created(){
