<template>
  <div class="page-wrapper">
     ...
     <h2 class="font-italic font-weight-light font-weight-bold">Delivery Policy sort</h2>

      <div>
         <router-link to="/DeliveryPolicy"> <span> Delivery Policy </span> </router-link> / <span>Sort</span>
      </div>
...
<script>
  ...
  export default {
    name: 'DeliveryPolicy-sort',
    mixins: [AdminSortMixin],
    data: () => ({
        Permission: 'DeliveryPolicy',
        api_get_listWithoutPaginate: 'DeliveryPolicy/list_without_paginate',
        api_updateRowsPosition: 'DeliveryPolicy/updateRowsPosition',
    }),//end data
    created(){
