<template>
  <div class="page-wrapper">
     ...
     <h2 class="font-italic font-weight-light font-weight-bold">FAQs sort</h2>

      <div>
         <router-link to="/PopularQuestion"> <span> FAQs </span> </router-link> / <span>Sort</span>
      </div>
...
<script>
  ...
  export default {
    name: 'PopularQuestionSort',
    mixins: [AdminSortMixin],
    data: () => ({
        Permission: 'PopularQuestion',
        api_get_listWithoutPaginate: 'PopularQuestion/list_without_paginate',
        api_updateRowsPosition: 'PopularQuestion/updateRowsPosition',
    }),//end data
    created(){
