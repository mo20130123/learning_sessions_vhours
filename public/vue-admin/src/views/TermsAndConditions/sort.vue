<template>
  <div class="page-wrapper">
     ...
     <h2 class="font-italic font-weight-light font-weight-bold">Terms & Conditions sort</h2>

      <div>
         <router-link to="/TermsAndConditions"> <span> Terms & Conditions   </span> </router-link> / <span>Sort</span>
      </div>
...
<script>
  ...
  export default {
    name: 'TermsAndConditions-sort',
    mixins: [AdminSortMixin],
    data: () => ({
        Permission: 'Product',
        api_get_listWithoutPaginate: 'TermsAndConditions/list_without_paginate',
        api_updateRowsPosition: 'TermsAndConditions/updateRowsPosition',
    }),//end data
    created(){
