<template>
  <div class="page-wrapper">
     ...
     <h2 class="font-italic font-weight-light font-weight-bold">Terms & Conditions</h2>
     ...
     <section class="section-page-control">
        <v-row>
           <v-col cols="7" >
             ...
             <router-link to="/TermsAndConditions/sort"> <v-btn class="ma-2" outlined color="black"> <b-icon-filter></b-icon-filter> Sort  </v-btn> </router-link>
          </v-col>
          <v-col>
                <div class="">
                         ...
                         <v-form  id="edit_image" ref="editForm" v-model="isValid_editForm" :lazy-validation="false" >
                             <v-row>
                                ...
                                <v-col>
                                     ...
                                     <v-textarea label="Body Ar" v-model="EF.text_ar" name="input-7-4" outlined rows="15" :rules="requiredRules"></v-textarea>
                                 </v-col>
                             </v-row>
                         </v-form>
                           <!-- - - - - - -START spinner- - - - - - - -->
  ...
  export default {
    ...
    mixins: [AdminMixin],
     data: () => ({
        ...
        api_get_list: 'TermsAndConditions/list',
        api_showORhide: 'TermsAndConditions/showORhide',
        api_delete: 'TermsAndConditions/delete',
        api_create: 'TermsAndConditions/create',
        api_update: 'TermsAndConditions/update',
    }),//end data
    created(){
