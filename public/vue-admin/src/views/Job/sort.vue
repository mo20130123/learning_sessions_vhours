<template>
  <div class="page-wrapper">
     ...
     <h2 class="font-italic font-weight-light font-weight-bold">Jobs sort</h2>

      <div>
         <router-link to="/Job"> <span> Jobs </span> </router-link> / <span>Sort</span>
      </div>
...
<script>
  ...
  export default {
    ...
    data: () => ({
        Permission: 'Job',
        api_get_listWithoutPaginate: 'Job/list_without_paginate',
        api_updateRowsPosition: 'Job/updateRowsPosition',
    }),//end data
    created(){
