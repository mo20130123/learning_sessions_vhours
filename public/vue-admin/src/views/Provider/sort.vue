<template>
  <div class="page-wrapper">
     ...
     <h2 class="font-italic font-weight-light font-weight-bold">Providers sort</h2>

      <div>
         <router-link to="/Provider"> <span> Provider </span> </router-link> / <span>Sort</span>
      </div>
...
<script>
  ...
  export default {
    ...
    data: () => ({
        Permission: 'Provider',
        api_get_listWithoutPaginate: 'Provider/list_without_paginate',
        api_updateRowsPosition: 'Provider/updateRowsPosition',
    }),//end data
    created(){
