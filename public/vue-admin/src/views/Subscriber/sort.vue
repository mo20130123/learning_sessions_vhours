<template>
  <div class="page-wrapper">
     ...
     <h2 class="font-italic font-weight-light font-weight-bold">Contact Us sort</h2>

      <div>
         <router-link to="/Subscriber"> <span> Mini Home Slider </span> </router-link> / <span>Sort</span>
      </div>
...
<script>
  ...
  export default {
    name: 'Subscriber-sort',
    mixins: [AdminSortMixin],
    data: () => ({
        api_get_listWithoutPaginate: 'Subscriber/list_without_paginate',
        api_updateRowsPosition: 'Subscriber/updateRowsPosition',
    }),//end data
    created(){
