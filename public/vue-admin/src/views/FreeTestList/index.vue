<template>
  <div class="page-wrapper">
     ...
     <h2 class="font-italic font-weight-light font-weight-bold">Free Test </h2>
     ...
     <section class="section-page-control">
        <v-row>
           <v-col cols="7" >
             ...
             <router-link to="/FreeTestList/sort"> <v-btn class="ma-2" outlined color="black"> <b-icon-filter></b-icon-filter> Sort  </v-btn> </router-link>
                      ...
                      <v-row>
                        <v-col>
                            <div class="div_Preview_image">
                               ...
                               <v-file-input @change="Preview_image($event,'Preview_image_create')" label="File input" name="image" hint="435px*311px Pixels" persistent-hint="true" prepend-icon="" show-size outlined ></v-file-input>
                            </div>
                      ...
                      <v-row>
                        <v-col>
                            <div class="div_Preview_image">
                               ...
                               <v-file-input @change="Preview_image($event,'Preview_image_edit')" label="File input" name="image" hint="435px*311px Pixels" persistent-hint="true" prepend-icon="" show-size outlined ></v-file-input>
                            </div>
...
<script>
  ...
  export default {
    ...
    mixins: [AdminMixin],
     data: () => ({
        Permission: 'FreeTestList',
        api_get_list: 'FreeTestList/list',
        api_showORhide: 'FreeTestList/showORhide',
        api_delete: 'FreeTestList/delete',
        api_create: 'FreeTestList/create',
        api_update: 'FreeTestList/update',
    }),//end data
    created(){
