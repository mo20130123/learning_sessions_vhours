<template>
  <div class="page-wrapper">
     ...
     <h2 class="font-italic font-weight-light font-weight-bold">Mini Home Slider sort</h2>
      ...
      <div>
         <router-link to="/Client"> <span> Mini Home Slider </span> </router-link> / <span>Sort</span>
      </div>
...
<script>
  ...
  export default {
    ...
    data: () => ({
        Permission: 'Client',
        api_get_listWithoutPaginate: 'Client/list_without_paginate',
        api_updateRowsPosition: 'Client/updateRowsPosition',
    }),//end data
    created(){
