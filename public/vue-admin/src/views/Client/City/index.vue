<template>
  <div class="page-wrapper">
     ...
     <h2 class="font-italic font-weight-light font-weight-bold">City</h2>
     ...
     <section class="section-page-control">
        <v-row>
           <v-col cols="7" >
             ...
             <!-- <router-link to="/City/sort"> <v-btn class="ma-2" outlined color="black"> <b-icon-filter></b-icon-filter> Sort  </v-btn> </router-link> -->
...
<script>
  ...
  export default {
    ...
    mixins: [AdminMixin],
     data: () => ({
        Permission: 'City',
        api_get_list: 'City/list',
        api_showORhide: 'City/showORhide',
        api_delete: 'City/delete',
        api_create: 'City/create',
        api_update: 'City/update',
    }),//end data
    created(){
