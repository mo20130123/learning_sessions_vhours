<template>
  <div class="page-wrapper">
     ...
     <h2 class="font-italic font-weight-light font-weight-bold">Clients</h2>
     ...
     <section class="section-page-control">
        <v-row>
           <v-col cols="7" >
             ...
             <router-link to="/Client/sort"> <v-btn class="ma-2" outlined color="black"> <b-icon-filter></b-icon-filter> Sort  </v-btn> </router-link>
...
<script>
  ...
  export default {
    ...
    mixins: [AdminMixin],
     data: () => ({
        Permission: 'Client',
        api_get_list: 'Client/list',
        api_showORhide: 'Client/showORhide',
        api_delete: 'Client/delete',
        api_create: 'Client/create',
        api_update: 'Client/update',
    }),//end data
    created(){
