<template>
  <div class="page-wrapper">
     ...
     <h2 class="font-italic font-weight-light font-weight-bold">Bundels sort</h2>

      <div>
         <router-link to="/Bundel"> <span> Bundels </span> </router-link> / <span>Sort</span>
      </div>
...
<script>
  ...
  export default {
    ...
    data: () => ({
        Permission: 'Bundel',
        api_get_listWithoutPaginate: 'Bundel/list_without_paginate',
        api_updateRowsPosition: 'Product/updateRowsPositionWithclassification/bundle',
        Permission: 'Bundel'
    }),//end data
    created(){
