<template>
  <div class="page-wrapper">
     ...
     <h2 class="font-italic font-weight-light font-weight-bold">PdfDownloads sort</h2>

      <div>
         <router-link to="/PdfDownloads"> <span> PdfDownloads </span> </router-link> / <span>Sort</span>
      </div>
...
<script>
  ...
  export default {
    name: 'PdfDownloads-sort',
    mixins: [AdminSortMixin],
    data: () => ({
        Permission: 'PdfDownloads',
        api_get_listWithoutPaginate: 'PdfDownloads/list_without_paginate',
        api_updateRowsPosition: 'PdfDownloads/updateRowsPosition',
    }),//end data
    created(){
