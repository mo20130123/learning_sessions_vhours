<template>
  <div class="page-wrapper">
     ...
     <h2 class="font-italic font-weight-light font-weight-bold">Product Sub Categories sort</h2>

      <div>
         <router-link to="/ProductSubCategory"> <span> Product Categories </span> </router-link> / <span>Sort</span>
      </div>
...
<script>
  ...
  export default {
    name: 'ProductSubCategory-sort',
    mixins: [AdminSortMixin],
    data: () => ({
        Permission: 'Product',
        api_get_listWithoutPaginate: 'ProductSubCategory/list_without_paginate',
        api_updateRowsPosition: 'ProductSubCategory/updateRowsPosition',
    }),//end data
    created(){
