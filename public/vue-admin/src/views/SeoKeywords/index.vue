<template>
  <div class="page-wrapper">
     ...
     <h2 class="font-italic font-weight-light font-weight-bold">Seo Keywords</h2>
  ...
  export default {
    ...
    mixins: [AdminMixin],
     data: () => ({
        ...
        api_get_list: 'SeoKeywords/list',
        api_showORhide: 'SeoKeywords/showORhide',
        api_delete: 'SeoKeywords/delete',
        api_create: 'SeoKeywords/create',
        api_update: 'SeoKeywords/update',
    }),//end data
    created(){
